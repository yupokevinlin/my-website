...
const Skills: React.FC = () => {
  ...
  return (
    <div className="w-full flex flex-col items-center justify-center h-max content-grid-bg">
      {renderCategory("STYLING", [["./resources/images/skills/css3.png","CSS"],["./resources/images/skills/tailwind.png","Tailwind CSS"],["./resources/images/skills/sass.svg","Sass"],["./resources/images/skills/jss.svg","JSS"],["./resources/images/skills/bootstrap.png","Bootstrap"],["./resources/images/skills/mui.png","Material UI"],["./resources/images/skills/fluentui.svg","Fluent UI"]])}
      {renderCategory("FRONT END", [["./resources/images/skills/html5.png","HTML"],["./resources/images/skills/javascript.png","JavaScript"],["./resources/images/skills/typescript.png","TypeScript"],["./resources/images/skills/react.svg","React JSX"],["./resources/images/skills/next.svg","Next.js"],["./resources/images/skills/next-auth.png","Next Auth"],["./resources/images/skills/redux.svg","Redux"],["./resources/images/skills/reduxsaga.svg","Redux Saga"],["./resources/images/skills/reactnative.png","React Native"],["./resources/images/skills/electron.png","Electron"],["./resources/images/skills/jquery.png","jQuery"],["./resources/images/skills/jest.png","Jest"],["./resources/images/skills/rtl.png","React Testing Library"],["./resources/images/skills/selenium.png","Selenium"]])}
      ...
      {renderCategory("BACK END", [["./resources/images/skills/node.png","Node.js"],["./resources/images/skills/express.svg","Express"],["./resources/images/skills/springboot.png","Spring Boot"],["./resources/images/skills/wildfly.svg","Wildfly"]])}
      {renderCategory("DATABASE", [["./resources/images/skills/mongodb.svg","Mongo DB"],["./resources/images/skills/postgres.png","Postgres SQL"],["./resources/images/skills/mssql.svg","Microsoft SQL"],["./resources/images/skills/graphql.png","GraphQL"]])}
      {renderCategory("DEVOPS", [["./resources/images/skills/git.png","Git"],["./resources/images/skills/github.png","GitHub"],["./resources/images/skills/openshift.png","OpenShift"],["./resources/images/skills/jenkins.png","Jenkins"],["./resources/images/skills/docker.svg","Docker"],["./resources/images/skills/nginx.png","Nginx"]])}
      {renderCategory("MACHINE LEARNING", [["./resources/images/skills/tensorflow.svg","Tensorflow"],["./resources/images/skills/opencv.svg","OpenCV"]])}
